...
logger.debug    = function (msg: any) {console.debug(`${this.date()}\t${this.TYPE.DEBUG}\t${msg} ${this.getCallSite()}`)}
logger.info     = function (msg: any) {console.info(`${this.date()}\t${this.TYPE.INFO}\t${msg} ${this.getCallSite()}`)}
logger.warn     = function (msg: any) {console.warn(`${this.date()}\t${this.TYPE.WARN}\t${msg} ${this.getCallSite()}`)}
logger.error    = function (msg: any) {console.error(`${this.date()}\t${this.TYPE.ERROR}\t${msg} ${this.getCallSite()}`)}